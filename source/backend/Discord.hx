...
class DiscordClient
{
	...
	private static final _defaultID:String = "1252756535596023940";
	...
	public static function changePresence(?details:String = 'Exploring...', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
