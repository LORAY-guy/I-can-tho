...
class BaseRoom extends FlxTypedGroup<FlxBasic>
{
	...
	//Made those lists so that there can be multiple enemies per room if desired (prob for a future feature or something)
	...
	public var phone(get, never):PhoneCall;
	...
	inline private function get_phone():PhoneCall return game.phone;
